...
export default {
    ...
    EUNKPAR: `Unknown data type found %s at offset %s`,
    ...
    WUNREAC: `WARNING: Unreachable branch found at %s`,
    WUNLOOP: `WARNING: Unknown loop type with header %s and latching node %s`
};
